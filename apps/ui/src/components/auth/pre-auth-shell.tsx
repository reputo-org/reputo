...
/**
 * Centered card layout shared by every pre-authentication route. A bounded
 * card holds the hero + CTAs. Classic Stripe / Auth0 / Firebase pattern,
 * tuned for an OAuth-only flow with a tight 440px column.
 */
